...
- Cách sử dụng: 
	...
	+ B4: Mở trình duyệt theo đường dẫn: http://localhost:8091/BTL_LTMM <br/>
		(Trên là port mặc định local của Project, nếu port 8091 đã được một tiến trình hoặc phần mềm khác sử dụng thì ta tiến hành đổi port khác) <br/>
	=> Cách đối port khác: 
